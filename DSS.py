...
#os.chdir("C:/Users/LASHSIG1/Desktop/Repertoire")
print("\n\nLe Repertoire courant est :", os.getcwd(), "\n\n")
param = open("C:\Users\LASHSIG1\Desktop\Repertoire\param", "r")
...
# Lire la 5eme ligne de param et la transfomée en liste de valeur auquel on affecte les variables nj, vnj
nj, vnj = param.readline().split()
vnj=int(vnj)
# Lire la 6eme ligne de param et la transfomée en liste de valeur auquel on affecte les variables lPas, vPas
lPas, vPas   = param.readline().split()
vPas=int(vPas)
# Lire la 7eme ligne de param et la transfomée en liste de valeur auquel on affecte les variables lDelta, vDelta
...
while line:
	...
	ouf = open(oufname, "w")
	ouf.write ("//" + vStation + "/PRECIP-INC/" + str(jour).zfill(2) + cMois[int(vMois)-1] + str(vAn).zfill(4) + "/"+str(vPas).zfill(1)+"hours/GAGE/\n")
	nbLine = 0
	cStartDate = "START"
	cEndDate = "END"
	outLine = []
...
station1file=open("C:/Users/LASHSIG1/Desktop/HEC-DSSVue 2.0.1"+"/"+vData_Dest+"/"+"Bab_Ouender", "r")
station2file=open("C:/Users/LASHSIG1/Desktop/HEC-DSSVue 2.0.1"+"/"+vData_Dest+"/"+"Jbel_Outka", "r")
...
try : 
  try :
    myDss = HecDss.open("C:\Users\LASHSIG1\Desktop\Repertoire\HMSFILES\wmsexport.dss")
